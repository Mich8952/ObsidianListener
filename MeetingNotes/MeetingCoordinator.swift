...
@MainActor final class MeetingCoordinator: ObservableObject {
    ...
    func start() async {
        guard state == .idle else { return }; state = .preparing
